# City Pages Checklist - 100 Target Cities

**Goal:** Create city-specific landing pages for wind load requirements
**Template:** State HTML files (e.g., florida-wind-load-requirements.html)
**URL Pattern:** `[city]-wind-load-requirements.html`

---

## Tier 1: Major Coastal & High-Risk Markets (1-25)
*Highest wind load concerns - hurricanes, coastal exposure*

- [x] 1. Miami, FL ✅ (cities/miami-wind-load-requirements.html)
- [x] 2. Houston, TX ✅ (cities/houston-wind-load-requirements.html)
- [x] 3. Tampa, FL ✅ (cities/tampa-wind-load-requirements.html)
- [x] 4. New Orleans, LA ✅ (cities/new-orleans-wind-load-requirements.html)
- [x] 5. Jacksonville, FL ✅ (cities/jacksonville-wind-load-requirements.html)
- [x] 6. Fort Lauderdale, FL ✅ (cities/fort-lauderdale-wind-load-requirements.html)
...
## Priority Logic
- **Tier 1** = Coastal/hurricane markets (highest wind load demand)
- **Tier 2** = Major metros (highest search volume)
- **Tier 3** = Tornado Alley + secondary markets
- **Tier 4** = Regional coverage completion
