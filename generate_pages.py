#!/usr/bin/env python3
"""
Generate all 39 educational pages from pages_data.json
"""
import json
...
<head>
    ...
    <style>
        * {{
        ...
        .sub-menu a:nth-child(1) i {{ color: #06b6d4; }}
        .sub-menu a:nth-child(2) i {{ color: #f97316; }}
        .sub-menu a:nth-child(3) i {{ color: #a855f7; }}
        .sub-menu a:nth-child(4) i {{ color: #10b981; }}

        /* Hero Section */
        .hero {{
            margin-top: 80px;
            background: linear-gradient(135deg, {page_data['color']} 0%, {page_data['color']}dd 100%);
            color: white;
        ...
        .content-section h2 {{
            ...
            border-bottom: 3px solid {page_data['color']};
        }}
        ...
        .highlight-box {{
            background: linear-gradient(135deg, {page_data['color']}15 0%, {page_data['color']}05 100%);
            border-left: 4px solid {page_data['color']};
            padding: 2rem;
            border-radius: 12px;
            margin: 2rem 0;
        }}
...
<body>
    ...
    <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="menu-items">
            ...
            <div class="nav-item-with-submenu">
                ...
                <div class="sub-menu">
                    <a href="asd-allowable-stress-design.html"><i class="fas fa-ruler-combined"></i> ASD Method</a>
                    <a href="lrfd-load-resistance-factor-design.html"><i class="fas fa-calculator"></i> LRFD Method</a>
                    <a href="nominal-wind-loads.html"><i class="fas fa-chart-line"></i> Nominal Loads</a>
                    <a href="ultimate-wind-loads.html"><i class="fas fa-arrow-up"></i> Ultimate Loads</a>
                    <a href="strength-design-wind-loads.html"><i class="fas fa-hard-hat"></i> Strength Design</a>
                </div>
            </div>
            ...
            <!-- Exposure Categories -->
            <div class="nav-item-with-submenu">
                <a href="wind-exposure-categories.html">
                    <i class="fas fa-city"></i> Exposure Categories
                    <i class="fas fa-chevron-down submenu-toggle"></i>
                </a>
                <div class="sub-menu">
                    <a href="exposure-b-urban-suburban.html"><i class="fas fa-building"></i> Exposure B</a>
                    <a href="exposure-c-open-terrain.html"><i class="fas fa-tree"></i> Exposure C</a>
                    <a href="exposure-d-flat-unobstructed.html"><i class="fas fa-water"></i> Exposure D</a>
                    <a href="surface-roughness-coefficient.html"><i class="fas fa-layer-group"></i> Surface Roughness</a>
                    <a href="velocity-pressure-exposure-coefficient.html"><i class="fas fa-wind"></i> Kz & Kh</a>
                </div>
            </div>

            <!-- Wind Speed & Velocity -->
            <div class="nav-item-with-submenu">
                <a href="wind-speed-zones-velocity-maps.html">
                    <i class="fas fa-tachometer-alt"></i> Wind Speed & Velocity
                    <i class="fas fa-chevron-down submenu-toggle"></i>
                </a>
                <div class="sub-menu">
                    <a href="asce-7-wind-load-velocity-finder-wind-speed-by-zip-code.html"><i class="fas fa-search-location"></i> Speed by Zip Code</a>
                    <a href="basic-wind-speed-asce-7.html"><i class="fas fa-gauge-high"></i> Basic Wind Speed</a>
                    <a href="ultimate-wind-speed-maps.html"><i class="fas fa-map"></i> Ultimate Maps</a>
                    <a href="nominal-wind-speed-conversion.html"><i class="fas fa-exchange-alt"></i> Speed Conversion</a>
                </div>
            </div>

            <!-- Risk Categories -->
            <div class="nav-item-with-submenu">
                <a href="risk-categories-asce-7.html">
                    <i class="fas fa-shield-alt"></i> Risk Categories
                    <i class="fas fa-chevron-down submenu-toggle"></i>
                </a>
                <div class="sub-menu">
                    <a href="risk-category-i-low-hazard.html"><i class="fas fa-warehouse"></i> Category I</a>
                    <a href="risk-category-ii-standard.html"><i class="fas fa-home"></i> Category II</a>
                    <a href="risk-category-iii-substantial-hazard.html"><i class="fas fa-school"></i> Category III</a>
                    <a href="risk-category-iv-essential-facilities.html"><i class="fas fa-hospital"></i> Category IV</a>
                </div>
            </div>

            <!-- HVHZ -->
            <div class="nav-item-with-submenu">
                <a href="hvhz-high-velocity-hurricane-zones.html">
                    <i class="fas fa-hurricane"></i> HVHZ
                    <i class="fas fa-chevron-down submenu-toggle"></i>
                </a>
                <div class="sub-menu">
                    <a href="hvhz-florida-requirements.html"><i class="fas fa-map-pin"></i> Florida HVHZ</a>
                    <a href="hvhz-wind-speeds-180mph.html"><i class="fas fa-wind"></i> 180 mph Zones</a>
                    <a href="hvhz-building-code-compliance.html"><i class="fas fa-clipboard-check"></i> Code Compliance</a>
                    <a href="hvhz-design-pressure-requirements.html"><i class="fas fa-compress"></i> Design Pressures</a>
                </div>
            </div>

            <!-- Wind Directionality -->
            <div class="nav-item-with-submenu">
                <a href="wind-directionality-factor-kd.html">
                    <i class="fas fa-compass"></i> Directionality (Kd)
                    <i class="fas fa-chevron-down submenu-toggle"></i>
                </a>
                <div class="sub-menu">
                    <a href="kd-factor-buildings-structures.html"><i class="fas fa-building"></i> Kd for Buildings</a>
                    <a href="directional-procedure-wind-loads.html"><i class="fas fa-arrows-alt"></i> Directional Method</a>
                </div>
            </div>
            ...
            <a href="solar-panel-wind-loads-asce-7.html"><i class="fas fa-solar-panel"></i> Solar Wind Loads</a>
    ...
    <section class="hero">
        <div class="hero-content">
            <div class="hero-icon"><i class="fas {page_data['icon']}"></i></div>
            <h1>{page_data['hero_title']}</h1>
            <p>{page_data['hero_subtitle']}</p>
        </div>
    </section>
    ...
    <main class="main-content">
        <div class="content-section">
            <h2>Overview</h2>
            <p>This comprehensive guide covers everything you need to know about {page_data['hero_title'].lower()}. We'll explore the key concepts, requirements, and practical applications per ASCE 7-22 standards.</p>
        ...
        <div class="content-section">
            ...
            <ul>
                <li><a href="asce-7-standards.html" style="color: {page_data['color']}; text-decoration: none; font-weight: 600;">ASCE 7 Standards Guide</a></li>
                <li><a href="state-requirements.html" style="color: {page_data['color']}; text-decoration: none; font-weight: 600;">State Requirements</a></li>
                <li><a href="resources.html" style="color: {page_data['color']}; text-decoration: none; font-weight: 600;">Free Resources & Tools</a></li>
                <li><a href="articles.html" style="color: {page_data['color']}; text-decoration: none; font-weight: 600;">Educational Articles</a></li>
            </ul>
        </div>
    </main>
...
print(f"\n✅ Successfully generated all {len(pages['pages'])} pages!")
print("\nPages created:")
for page in pages['pages']:
